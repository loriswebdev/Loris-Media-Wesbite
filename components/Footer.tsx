    ...
    <footer className="bg-gradient-blue-dark text-white">
      ...
      <div className="w-full pb-20 pl-5 pr-5 md:flex-row flex-col flex justify-center items-center md:justify-around">
        <div className="md:w-fit ">
          ...
          {pathname === '/contact-us' && <><h3 className="w-fit md:text-[1.5rem] text-center before:mt-[11px] text-[1.25rem] md:before:mt-[18px] lg:before:mt-[18px] lg:text-[1.75rem] tracking-wider items-start flex gap-2 before:h-[4px] lg:before:h-[5px] before:w-[20px] lg:before:w-[25px] before:relative before:inline-block before:bg-white">
              <span><span className="font-extrabold">Contact us</span> on<br/> WhatsApp</span>
            </h3>
            ...
            <p className="text-center text-[1rem] md:text-[1.25rem] lg:text-[1.3rem] pb-[5px] ml-[21px] w-[calc(100%-21px) md:w-[calc(100%-28px) lg:w-[calc(100%-33px)] md:ml-[28px] lg:ml-[33px] mb-8 md:mb-24">+52 56 2999 7499</p></Link></>}
         ...
         { pathname !== '/contact-us' && <h2 className="md:text-left text-center md:inline-block text-[1.5rem] md:text-[3.75rem] lg:text-[5rem] md:pl-[70px] font-extrabold leading-[.9] mt-10">
